  ...
  Future<void> handleToDeviceEvent(ToDeviceEvent event) async {
    if (event.type == EventTypes.RoomKeyRequest) {
      ...
      if (event.content['action'] == 'request') {
        ...
        final senderDeviceKeys = await client.fetchUserDeviceKeysLists({
          event.sender,
        });
        final device = senderDeviceKeys[event.sender]
      ...
      final sender_ed25519 = senderDeviceKeys[event.sender]
          ?.deviceKeys[event.content['requesting_device_id']]
          ?.ed25519Key;
