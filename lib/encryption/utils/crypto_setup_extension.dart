...
extension CryptoSetupExtension on Client {
  /// Returns the current state of the crypto identity. If initialized is
  /// true, then `Client.restoreCryptoIdentity()` can be used to connect. When
  /// initialized is false, then `Client.initCryptoIdentity()` must
  /// be executed first.
