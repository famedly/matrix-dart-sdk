...
void main() {
  group('Key Manager', tags: 'olm', () {
    ...
    test('replace persisted outbound Megolm v2 session before sending',
        () async {
      ...
      final storedReplacement = await client.database
          .getOutboundGroupSession(roomId, userId);
      expect(storedReplacement!.outboundGroupSession!.sessionConfigVersion, 1);
