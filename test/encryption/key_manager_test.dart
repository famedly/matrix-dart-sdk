...
void main() {
  group('Key Manager', () {
    ...
    test('inbound group session', () async {
      ...
      final sessionContent = <String, Object?>{
        'algorithm': AlgorithmTypes.megolmV1AesSha2,
        'room_id': '!726s6s6q:example.com',
    ...
    test('setInboundGroupSession', () async {
      ...
      // set a payload...
      var sessionPayload = <String, Object?>{
        'algorithm': AlgorithmTypes.megolmV1AesSha2,
        'room_id': roomId,
    ...
    test('Reused deviceID attack', () async {
      ...
      final oldResp = (FakeMatrixApi.currentApi?.api['POST']
              ?['/client/v3/keys/query'] as Function)
          .call(null);
