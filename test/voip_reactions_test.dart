...
void main() {
  ...
  group('VoIP Reaction Events Tests', () {
    ...
    test('Test hand raise reaction receiving and state management', () async {
      ...
      expect(addedEvent.eventId, 'membership_event_reactions');
    ...
    test('Test current user own reaction events are processed', () async {
      ...
      expect(addedEvent.eventId, 'my_membership_event');
    ...
    test('Test ephemeral vs permanent reactions', () async {
      ...
      final ephemeralEvent = reactionEvents[0] as ReactionAddedEvent;
      final permanentEvent = reactionEvents[1] as ReactionAddedEvent;
    ...
    test('Test ephemeral reaction timeout handling', () async {
      ...
      final processedReactions = reactionEvents.cast<ReactionAddedEvent>();
