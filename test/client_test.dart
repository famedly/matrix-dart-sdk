...
void main() {
  ...
  group('Client', () {
                ...
                'state': {
                  'events': [
                    <String, Object?>{
                      'sender': '@alice:example.com',
                      'type': 'm.room.name',
                      'content': <String, Object?>{'name': 'foxies'},
                      'state_key': '',
                      'origin_server_ts': 1417731086799,
                      'event_id': '66697273743033:example.com'
                    }
    ...
    test('getProfileFromUserId', () async {
      ...
      expect(
        aliceProfile.avatarUrl.toString(),
      ...
      expect(
        json.decode(
          FakeMatrixApi.calledEndpoints[
              '/client/v3/sendToDevice/raccoon/raccoon_txnid']?[0] as String,
        )['messages'],
        raccoonContent,
      );
      FakeMatrixApi.calledEndpoints.clear();
